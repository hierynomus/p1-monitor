...
func NewCounterL(name, help string, labels map[string]string) prometheus.Counter {
	return iot.NewCounterL(namespace, name, help, labels)
}

func NewGaugeL(name, help string, labels map[string]string) prometheus.Gauge {
	return iot.NewGaugeL(namespace, name, help, labels)
}
...
func (p Provider) Metrics() map[string]iot.MetricCollector {
	return map[string]iot.MetricCollector{
		"1-0:1.8.1":   NewCounterL("electricity_delivered_to_client_kwh", "Meter Reading electricity delivered to client in 0,001 kWh", labels("tariff", "1", "dsmr_key", "1-0:1.8.1")),
		"1-0:1.8.2":   NewCounterL("electricity_delivered_to_client_kwh", "Meter Reading electricity delivered to client in 0,001 kWh", labels("tariff", "2", "dsmr_key", "1-0:1.8.2")),
		"1-0:2.8.1":   NewCounterL("electricity_delivered_by_client_kwh", "Meter Reading electricity delivered by client in 0,001 kWh", labels("tariff", "1", "dsmr_key", "1-0:2.8.1")),
		"1-0:2.8.2":   NewCounterL("electricity_delivered_by_client_kwh", "Meter Reading electricity delivered by client in 0,001 kWh", labels("tariff", "2", "dsmr_key", "1-0:2.8.2")),
		...
		"0-0:96.7.21": NewCounterL("power_failures_total", "Number of power failures in any phase", labels("dsmr_key", "0-0:96.7.21")),
		"0-0:96.7.9":  NewCounterL("long_power_failures_total", "Number of long power failures in any phase", labels("dsmr_key", "0-0:96.7.9")),
		"1-0:32.32.0": NewCounterL("voltage_sags", "Number of voltage sags", labels("phase", "L1", "dsmr_key", "1-0:32.32.0")),
		"1-0:52.32.0": NewCounterL("voltage_sags", "Number of voltage sags", labels("phase", "L2", "dsmr_key", "1-0:52.32.0")),
		"1-0:72:32.0": NewCounterL("voltage_sags", "Number of voltage sags", labels("phase", "L3", "dsmr_key", "1-0:72:32.0")),
		"1-0:32.36.0": NewCounterL("voltage_swells", "Number of voltage swells", labels("phase", "L1", "dsmr_key", "1-0:32.36.0")),
		"1-0:52.36.0": NewCounterL("voltage_swells", "Number of voltage swells", labels("phase", "L2", "dsmr_key", "1-0:52.36.0")),
		"1-0:72.36.0": NewCounterL("voltage_swells", "Number of voltage swells", labels("phase", "L3", "dsmr_key", "1-0:72.36.0")),
		...
		"0-1:24.2.3":  NewCounterL("gas_m3", "Actual gas volume delivered", labels("dsmr_key", "0-1:24.2.3")),
	}
}
